...
export function Home() {
  ...
  const textContainerStyle = {
    ...
    color: "white",
    padding: "8px",
    opacity: 1, // Set opacity to 1 to make it fixed
  };
  ...
  const handleOnClickMachine2 = (event) => {
    localStorage.setItem("machineId", '94E68600E0C0');
    navigate("/choose/2");
  };
  ...
  return (
    <div>
      ...
      <div style={imageContainerStyle} className="card-container">
        <div
          style={{ ...cardStyle, borderColor: "red" }}
          onMouseOver={handleHover}
          onMouseOut={handleHoverOut}
          onClick={handleOnClickMachine1}
        >
          <img
        ...
        <div
          style={{ ...cardStyle, borderColor: "blue" }}
          onMouseOver={handleHover}
          onMouseOut={handleHoverOut}
          onClick={handleOnClickMachine2}
        >
          <img
            src="https://static.vecteezy.com/system/resources/previews/004/596/922/original/vending-machine-line-icon-vector.jpg"
            alt="Machine 2"
